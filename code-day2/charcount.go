...
func main() {
	//统计一段英文字符中 ，各字符出现的次数
	ch := `I am happy to join with you today in what will go down in history as the greatest demonstration for freedom in the history of our nation.
